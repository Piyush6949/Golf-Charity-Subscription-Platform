...
A premium, emotion-driven web application where golf lovers subscribe, enter their Stableford scores, and compete in monthly draws—all while supporting charities that matter to them.

Built with modern web technologies and a focus on sleek, glassmorphic UI, responsive design, and dynamic financial calculations.
...
- **Styling**: Vanilla CSS with custom Tailwind-like utility classes and variables. Features advanced glassmorphism grids, floating orb animations, and gradient text.
